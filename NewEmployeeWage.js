...
//UC5 Calculate wage for a month or given Hours Limit
...

{
  ...
  console.log(
    "Total emp hours = " + totalEmpHrs + " Total employee wage = " + empWage
  );
  ...
  console.log(
    "UC7A - Emp Wage with reduce: " + empDailyWageArray.reduce(totalWages, 0)
  );
  ...
  console.log(
    "UC 7D - First time Full Time Wage earned on day: " +
  ...
  console.log(
    "UC 7E- Is every element holding full time wage- " +
  ...
  console.log(
    "UC 7F- Is part time wage present in any element? - " +
  ...
  console.log(
    "UC 7G- Number of days employee worked: " +
      empDailyWageArray.reduce(totalDaysEmployeeWorked, 0)
  );
...
//UC10
{
  ...
  let partWorkingDaysString = empDailyHrsAndWageArray
    .filter((dailyHrsAndWage) => dailyHrsAndWage.dailyHours == 4)
    .map((dailyHrsAndWage) => dailyHrsAndWage.toString());
  console.log("\n11C- Part Working Days" + partWorkingDaysString);

  let noWorkingDays = empDailyHrsAndWageArray
    .filter((dailyHrsAndWage) => dailyHrsAndWage.dailyHours == 0)
